...
public class CategoryController extends BaseController {
    ...
    private List<RTopCategory> loadTopCategory() {
        ...
        String jsonStr = NetworkUtil.doGet("http://mall.520it.com/category");
    ...
    private List<RSubCategory> loadSubCategory(long parentId) {
        ...
        String jsonStr = NetworkUtil.doGet("http://mall.520it.com/category?parentId=" + parentId);
    ...
    private List<RBrand> loadBrand(long topCategoryId) {
        ...
        String jsonStr = NetworkUtil.doGet("http://mall.520it.com/brand?categoryId=" + topCategoryId);
    ...
    private List<RProductList> loadProductList(SProductList sendArgs) {
        ...
        String jsonStr = NetworkUtil.doPost("http://mall.520it.com/searchProduct", params);
